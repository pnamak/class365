...
> = {
  ...
  teacher: {
    label: "Teacher",
    description: "Courses, gradebook, attendance, and distance learning tools.",
    accent: "amber",
  },
  student: {
    label: "Student",
...
export const ROLE_ROUTES: Record<UserRole, string[]> = {
  ...
  student: ["/dashboard", "/attendance", "/gradebook", "/courses", "/learning"],
  parent: ["/dashboard", "/attendance", "/gradebook", "/billing", "/courses"],
};
